...
// Pedidos de lugar en una clase (reemplaza al de grupos; aquel queda hasta la limpieza)
builder.Services.AddScoped<ISolicitudCupoRepository, SolicitudCupoRepository>();
builder.Services.AddScoped<ISolicitudCupoService, SolicitudCupoService>();
builder.Services.AddScoped<ISolicitudHorarioRepository, SolicitudHorarioRepository>();
